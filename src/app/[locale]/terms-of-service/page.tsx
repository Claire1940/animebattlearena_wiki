...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Anime Battle Arena Wiki",
    description: "Read the Terms of Service for Anime Battle Arena Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Anime Battle Arena Wiki",
      description: "Terms and conditions for using Anime Battle Arena Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Anime Battle Arena Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Anime Battle Arena Wiki (&quot;the Website&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;), you agree to be bound
              by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you (&quot;User&quot;, &quot;you&quot;, or &quot;your&quot;) and Anime Battle Arena Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Anime Battle Arena Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game &quot;Anime Battle Arena&quot; (ABA). Our services include, but are not limited to:
            </p>
            <ul>
              <li>Active codes and reward guides</li>
              <li>Character tier lists and rankings</li>
              <li>Combo and moveset breakdowns</li>
              <li>Character database and ability guides</li>
              <li>Arena PvP strategy and matchup tips</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Anime Battle Arena Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Anime Battle Arena (Dogs Studios South). We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Anime Battle Arena Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Anime Battle Arena (Dogs Studios South).
              We use such content under fair use principles for informational and educational purposes only.
            </p>
            ...
            <ul>
              ...
              <li><strong>Game Changes:</strong> Roblox game updates, character balance changes, and code expirations may occur without notice. We are not responsible for game changes or expired codes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, ANIME BATTLE ARENA WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Anime Battle Arena Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@animebattlearena.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@animebattlearena.wiki</a>
            </p>
            <p>
