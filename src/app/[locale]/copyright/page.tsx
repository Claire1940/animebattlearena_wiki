...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Anime Battle Arena Wiki',
    description: 'Copyright and intellectual property information for Anime Battle Arena Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Anime Battle Arena Wiki',
      description: 'Copyright and intellectual property information for Anime Battle Arena Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Anime Battle Arena Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Anime Battle Arena Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Anime Battle Arena Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
            ...
            <ul>
              ...
              <li>Character names, abilities, and movesets</li>
            ...
            <p>
              ...
              affiliation with Anime Battle Arena Wiki.
            </p>
            ...
            <p>
              ...
              Anime Battle Arena Wiki<br />
              Email: <a href="mailto:dmca@animebattlearena.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@animebattlearena.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to &quot;Anime Battle Arena Wiki&quot;</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>&quot;Source: Anime Battle Arena Wiki (animebattlearena.wiki)&quot;</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@animebattlearena.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@animebattlearena.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@animebattlearena.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@animebattlearena.wiki</a>
            </p>
            <p>
